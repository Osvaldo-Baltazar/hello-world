...
namespace Comanda
{
    class BaseDatos
    {
        ...
        public List<Aperitivo> ListAperitivos { get;  set; }
        public List<Ensaladas> Ensalada { get;  set; }

        public List<Carnes> ListCarnes { get;  set; }
        public List<Pescado> ListPescado { get;  set; }
        public List<Pollo> ListPollo { get;  set; }
        public List<Pastas> ListPasta { get;  set; }
        public List<Sandwichs> ListSandwich { get;  set; }
        public List<Paninis> ListPaninis { get;  set; }
        public List<Postres> ListPostre { get;  set; }
        public List<Bebidas> ListBebida { get; set; }
        public List<Empty> Vacio { get;  set; }
